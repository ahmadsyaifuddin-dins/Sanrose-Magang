<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('instansi.list')" :active="request()->routeIs('instansi.list')">
                        {{ __('Daftar Instansi') }}
                    </x-nav-link>

                    <x-nav-link :href="route('peta.index')" :active="request()->routeIs('peta.index')">
                        {{ __('Peta Lokasi') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('instansi.list')" :active="request()->routeIs('instansi.list')">
                {{ __('Daftar Instansi') }}
            </x-responsive-nav-link>
